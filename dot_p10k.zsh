# Generated by Powerlevel10k configuration wizard on 2022-02-13 at 17:04 NZDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 53041.
# Wizard options: awesome-fontconfig, large icons, rainbow, ascii, 24h time, 2 lines,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND=$BG_HI
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_GAP_BACKGROUND=
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    # The color of the filler. You'll probably want to match the color of POWERLEVEL9K_MULTILINE
    # ornaments defined above.
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$FG_LO
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$GRE
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$BG_HI
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$BLU
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$VIO
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$BLU
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=$BG_HI
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=$BG_HI
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=$BG_HI
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=$BG_HI
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=$BG_HI
  ...
  function my_git_formatter() {
    ...
    local       meta='%'${FG}'F'
    local      clean='%'${GRE}'F'
    local   modified='%'${YEL}'F'
    local  untracked='%'${BLU}'F'
    local conflicted='%'${RED}'F'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$FG
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=$BG_HI
  ...
  # (see below) that gets matched. If you unset all POWERLEVE/L9K_GOOGLE_APP_CRED_*CONTENT_EXPANSION
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$FG_LO
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$BG_HI
